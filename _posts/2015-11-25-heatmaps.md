...
* zlim: Selects the limits of the data after scaling. Note that if you use anything else than unit variance scaling you should consider these limits. -3 to 3 probably doesn't make sense in any other case. You can disable the limits using.
...
I hope you enjoy the read and now feel you know exactly what the heatmap funcions do.
<br><br>
...
Does look so bad right? Wrong! Compared to the last plot we did in the previous section you might think the clustering doesn't look that different.
